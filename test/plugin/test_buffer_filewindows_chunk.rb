...
class BufferFileWindowsChunkTest < Test::Unit::TestCase
  setup do
    @klass = Fluent::Plugin::Buffer::FileWindowsChunk
  ...
  sub_test_case 'newly created chunk' do
    setup do
      ...
      @c = Fluent::Plugin::Buffer::FileWindowsChunk.new(gen_metadata, @chunk_path, :create)
    end
  ...
  sub_test_case 'chunk with file for staged chunk' do
    setup do
      ...
      @c = Fluent::Plugin::Buffer::FileWindowsChunk.new(gen_metadata, @chunk_path, :staged)
    end
  ...
  sub_test_case 'chunk with file for enqueued chunk' do
    setup do
      ...
      @c = Fluent::Plugin::Buffer::FileWindowsChunk.new(gen_metadata, @enqueued_path, :queued)
    end
  ...
  sub_test_case 'chunk with queued chunk file of v0.12, without metadata' do
    setup do
      ...
      @c = Fluent::Plugin::Buffer::FileWindowsChunk.new(gen_metadata, @chunk_path, :queued)
    end
